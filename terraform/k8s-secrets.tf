...
data:
  ...
  MONGODB_URI: ${base64encode("mongodb://${var.mongo_user}:${var.mongo_password}@mongodb-service.tc4-customer.svc.cluster.local:27017/${var.mongo_db_name}?authSource=admin")}
